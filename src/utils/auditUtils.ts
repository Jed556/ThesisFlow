...
export function getAuditActionLabel(action: AuditAction): string {
    const labels: Record<AuditAction, string> = {
        ...
        // Template actions
        skill_template_created: 'Skill Created',
        skill_template_updated: 'Skill Updated',
        skill_template_deleted: 'Skill Deleted',
        skill_template_reset: 'Skills Reset',
        chapter_template_created: 'Chapter Template Created',
        chapter_template_updated: 'Chapter Template Updated',
        chapter_template_deleted: 'Chapter Template Deleted',
        chapter_template_reset: 'Chapter Templates Reset',
        agenda_template_updated: 'Agenda Updated',
        agenda_template_reset: 'Agenda Reset',
        // Other
